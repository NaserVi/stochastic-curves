...
import net.finmath.marketdata.model.stochastic.AnalyticModel;
import net.finmath.marketdata.products.stochastic.AbstractAnalyticProduct;
import net.finmath.marketdata.products.stochastic.SwapLeg;
import net.finmath.marketdata.products.stochastic.Swap;
import net.finmath.montecarlo.AbstractRandomVariableFactory;
import net.finmath.montecarlo.BrownianMotionInterface;
import net.finmath.montecarlo.RandomVariableFactory;
import net.finmath.montecarlo.automaticdifferentiation.RandomVariableDifferentiableAADFactory;
...
public class TestCurvesFromLIBORModel {
    ...
    public void testStochasticCurves() throws CalculationException{
		...
		net.finmath.marketdata.model.curves.stochastic.ForwardCurve forwardCurve = net.finmath.marketdata.model.curves.stochastic.ForwardCurve.createForwardCurveFromMonteCarloLiborModel("forwardCurve",liborMarketModel, evaluationTime);
        // Get value of analytic swap
		net.finmath.marketdata.model.curves.stochastic.DiscountCurveInterface discountCurve = net.finmath.marketdata.model.curves.stochastic.DiscountCurve.createDiscountCurveFromMonteCarloLiborModel("forwardCurve",liborMarketModel, evaluationTime);
