 ...
 */
public interface AnalyticProductInterfaceStochastic extends ProductInterface {
     ...
     */
    RandomVariableInterface getValue(double evaluationTime, AnalyticModelStochasticInterface model);
}