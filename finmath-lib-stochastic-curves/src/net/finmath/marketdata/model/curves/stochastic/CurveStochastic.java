...
public class CurveStochastic extends AbstractCurve implements Serializable, Cloneable {
	...
	public static class CurveBuilder implements CurveBuilderInterface {
		 ...
		 */
		public CurveBuilder(CurveStochastic curve) throws CloneNotSupportedException {
			this.curve = (CurveStochastic)curve.clone();
		}
	 ...
	 */
	public CurveStochastic(String name, 
	...
	protected CurveStochastic(String name, 
			        LocalDate referenceDate, 
			        InterpolationMethod interpolationMethod, 
			        ExtrapolationMethod extrapolationMethod, 
			        InterpolationEntity interpolationEntity,
	...
	@Override
	public CurveStochastic clone() throws CloneNotSupportedException {
		CurveStochastic newCurve = (CurveStochastic) super.clone();
