...
public interface ForwardCurveStochasticInterface extends CurveStochasticInterface {
	 ...
	 * @return The forward.
	 */
	RandomVariableInterface getForward(AnalyticModelStochasticInterface model, double fixingTime);
	 ...
	 * @return The forward.
	 */
	RandomVariableInterface getForward(AnalyticModelStochasticInterface model, double fixingTime, double paymentOffset);
