...
public abstract class AbstractForwardCurveStochastic extends CurveStochastic implements ForwardCurveStochasticInterface {
	...
	public AbstractForwardCurveStochastic(String name, 
			                    ...
			                    String discountCurveName,
			                    AbstractRandomVariableFactory factory) {
		this(name, referenceDate, paymentOffsetCode, paymentBusinessdayCalendar, paymentDateRollConvention, InterpolationMethod.LINEAR, ExtrapolationMethod.CONSTANT, InterpolationEntity.VALUE, discountCurveName, factory);
	}
	 ...
	 */
	public RandomVariableInterface[] getForwards(AnalyticModelStochasticInterface model, double[] fixingTimes)
	{
